...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Firebase.MLKit.Vision.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Firebase.Core.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Firebase.MLKit.Common.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "AccessibleMessaging.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
